...
//
//@Repository
//public class JoinRepositoryImpl implements JoinRepository, Serializable {
//
...
//                join.getJoin_text(), join.getJoin_file(), join.getJoin_subject(), join.getJoin_idx());
//    }
//
//    @Override
//    public void deleteContent(int join_idx) {
//        jdbcTemplate.update("delete from join_table where join_idx = ?", joinRowMapper(), join_idx);
//    }
//
//
