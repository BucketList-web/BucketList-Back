...
public class MainService {
  ...
  /*  public List<Participation> bestContent(){
        List<Participation> bestContents = participationRepository.findTop10ByOrderByCountDesc();
        return bestContents;
    }


    public List<Community> bestContentcommunity(){
        List<Community> bestContentscommunity = communityRepository.findTop10ByOrderByViewCountDesc();
        return bestContentscommunity;
    }
*/
}
